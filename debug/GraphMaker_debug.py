...
class GraphMaker:
    ...
    def cut_graph(self):
        ...
        # #############
        # # my_dinic
        # g = Graph(len(self.nodes)+2)
        # for node in self.nodes:
        #     # s
        #     g.addEdge(node[0], len(self.nodes), node[1])
        #     # t
        #     g.addEdge(node[0], len(self.nodes)+1, node[2])

        # for edge in self.edges:
        #     g.addEdge(edge[0], edge[1], edge[2])

        # flow = g.DinicMaxflow(len(self.nodes), len(self.nodes)+1)
